...
<head>
    ...
    <meta property="og:description"
          content="Restaurant food ordering Website is a catalyst for the food industry. The website lets you (a restaurateur) connect with the customers who wish to either get food delivered or pick-up food. The website lets you track customers’ order till the food delivery. With this website you can easily manage the entire restaurant food business to achieve maximum growth."/>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="{{URL::to('/')}}"><img
                    src='{!! asset("images/about/".$getabout->logo) !!}' alt=""></a>
                ...
                <ul class="navbar-nav">
                    ...
                    @if (Session::get('id'))
                        ...
                        <li class="nav-item cart-btn">
                            <a class="nav-link" href="{{URL::to('/cart')}}"><i class="fas fa-shopping-cart"></i><span
                                    id="cartcnt">{{Session::get('cart')}}</span></a>
                        </li>
                    @else
                        <li class="nav-item search">
                            <form method="get" action="{{URL::to('/search')}}">

...
<section class="signup-sec">
    ...
    <div class="container">
        <div class="signup-logo">
            <a href="{{URL::to('/')}}">
                <img src='{!! asset("images/about/".$getabout->logo) !!}' alt="">
        ...
        <form id="login" action="{{ URL::to('/email-verification') }}" method="post">
            ...
            @if (env('Environment') == 'sendbox')
                <input type="number" name="otp" id="otp" min="1" maxlength="6" placeholder="Verification code"
                       class="w-100" required="" value="{{Session::get('otp')}}">
            @else
                <input type="number" name="otp" id="otp" min="1" maxlength="6" placeholder="Verification code"
